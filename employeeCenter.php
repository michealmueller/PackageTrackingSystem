...
<div class="form-container">
    <div class="employee-center">
        <a href="AddUpdateCompany.php" class="btn btn-primary btn-lg" role="button">Add/Update Tracking Info &raquo;</a>
        <br>
        <br>
        <a href="uploadDocs.php" class="btn btn-primary btn-lg" role="button">Upload Documents &raquo;</a>
        <br>
        <br>

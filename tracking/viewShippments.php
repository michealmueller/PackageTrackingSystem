...
{
    session_destroy();
    echo '<div class="display"><p><h2>You are not a Customer so this page is not accessible to you!, <br><br>Sorry for the inconvenience</h2></p></div>';
    exit();
}
?>
<!--NAvBar-->
        ...
        <table border="0" class="table table-hover">
            ...
            <?php
                if(isset($_POST['submit']))
                {
                    ...
                    echo '</div><div class="instructions"><h4>Enter your Pro Number or Company Name to view shipment(s).</h4></div></div>';
                }
            ?>
        </table>
        <hr>
